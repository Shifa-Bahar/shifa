...
package com.lifepharmacy.application.ui.utils.taglayout;


import static com.lifepharmacy.application.ui.utils.taglayout.Utils.dp2px;
import static com.lifepharmacy.application.ui.utils.taglayout.Utils.sp2px;
...
public class TagContainerLayout extends ViewGroup {
  ...
  int selectedTextColor = Color.parseColor("#FFFFFFFF");
  int selectedBackgroundColor= Color.parseColor("#33F44336");
  /**
   ...
   */
  private int mTheme = com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.PURE_CYAN;
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
  ...
  private int[] onUpdateColorFactory() {
    int[] colors;
//        if (mTheme == com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.RANDOM) {
//            colors = com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.onRandomBuild();
//        } else if (mTheme == com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.PURE_TEAL) {
//            colors = com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.onPureBuild(com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.PURE_COLOR.TEAL);
//        } else if (mTheme == com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.PURE_CYAN) {
//            colors = com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.onPureBuild(com.lifepharmacy.application.ui.utils.taglayout.ColorFactory.PURE_COLOR.CYAN);
//        } else {
...
//        }
  ...
  private void onAddTag(String text, int position) {
    ...
    if (mDefaultImageDrawableID != -1) {
      tagView = new TagView(getContext(), text, mDefaultImageDrawableID, selected.contains(position));
    } else {
      tagView = new TagView(getContext(), text, selected.contains(position));
    }
  ...
  private void initTagView(TagView tagView, int position) {
    ...
    tagView.setTagSelectedMyBackgroundColor(selectedBackgroundColor);
    tagView.setTagSelectedTextColor(selectedTextColor);
  ...
  public void setSelecteColors(int selectedTextColor, int mSelectedTagBackgroundColor) {
    this.selectedTextColor = selectedTextColor;
    this.selectedBackgroundColor = mSelectedTagBackgroundColor;
