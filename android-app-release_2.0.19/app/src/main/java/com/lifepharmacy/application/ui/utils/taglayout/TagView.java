...
public class TagView extends View {
  ...
  private Runnable mLongClickHandle = new Runnable() {
    ...
    public void run() {
      if (!isMoved && !isUp) {
        int state = ((com.lifepharmacy.application.ui.utils.taglayout.TagContainerLayout) getParent()).getTagViewState();
  ...
  public TagView(Context context, String text,boolean isSelected) {
    super(context);
    this.isSelected = isSelected;
    init(context, text);
  }

  public TagView(Context context, String text, int defaultImageID,boolean isSelected) {
    super(context);
    this.isSelected = isSelected;
    init(context, text);
...
//                bug: https://github.com/whilu/AndroidTagView/issues/88
  ...
  public void setTagSelectedMyBackgroundColor(int color) {
