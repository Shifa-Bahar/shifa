...
import com.lifepharmacy.application.databinding.ItemHomeOptionsBinding
import com.lifepharmacy.application.model.home.SectionData

import kotlin.collections.ArrayList

class HomeOptionAdapter(context: Activity?, private val onItemTapped: ClickHomeSubItem) :
  RecyclerView.Adapter<HomeOptionAdapter.ItemViewHolder>() {
  var arrayList: ArrayList<SectionData>? = ArrayList()
  var activity: Activity? = context


  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
    val binding: ItemHomeOptionsBinding = DataBindingUtil.inflate(
  ...
  class ItemViewHolder internal constructor(itemView: View) :
    ...
    var binding: ItemHomeOptionsBinding? = DataBindingUtil.bind(itemView)
  }
