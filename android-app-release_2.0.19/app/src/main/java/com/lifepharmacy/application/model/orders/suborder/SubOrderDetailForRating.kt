...
import com.lifepharmacy.application.model.orders.Rating
...
@Parcelize
data class SubOrderDetailForRating(
...
//  var shipment: SubOrderShipment? = SubOrderShipment(),
  ...
  var items: ArrayList<SubOrderProductItem>? = ArrayList(),
...
//  var timeLines: ArrayList<TimeLine>? = ArrayList(),
  ...
  var subOrders: ArrayList<SubOrderItemWithJustItemOfRating>? = ArrayList(),
